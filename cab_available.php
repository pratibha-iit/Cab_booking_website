...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5 card rounded-0 card-outline card-purple shadow">
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <fieldset class="bor">
                    <legend class="h5 text-muted">Payment Options</legend>
                    <dl>
                        <dt class="">UPI ID</dt>
                        <dd class="pl-4">7250850915@ybl</dd>
                        <dt class="">Contact Number</dt>
                        <dd class="pl-4">9905879407</dd>
                        <dt class="">QR Code</dt>
                        <dd class="pl-4"><img src="uploads\QRcode.jpeg" alt="QR Code for Payment" style="max-width: 150px;"></dd>
                    </dl>
                </fieldset>
            </div>
        </div>
